...
// in reso_app/test/features/data/repositories/number_trivia_repository_impl_test.dart.
...
import 'package:reso_app/core/platform/network_info.dart' as _i7;
...
class MockNumberTriviaRemoteDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.NumberTriviaModel> getconcretNumberTrivia(
          {required int? number}) =>
      (super.noSuchMethod(
        Invocation.method(
...
/// A class which mocks [NumbeTriviaLocalDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockNumbeTriviaLocalDataSource extends _i1.Mock
    implements _i5.NumbeTriviaLocalDataSource {
  @override
